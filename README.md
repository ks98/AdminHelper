...
```bash
curl -fsSL https://raw.githubusercontent.com/ks98/AdminHelper/v0.30.2/scripts/install.sh \
  | bash -s -- --domain srm.example.com --ref v0.30.2
```
...
```bash
# Install the DEB:
sudo apt install ./adminhelper-agent_0.30.2_amd64.deb
